...
final _dishes = <_Dish>[
  _Dish(
    ...
    imageAsset: 'assets/food/corrientazo.jpg',
  ...
  _Dish(
    ...
    imageAsset: 'assets/food/bandeja.jpeg',
  ...
  _Dish(
    ...
    imageAsset: 'assets/food/caribe.jpeg',
    icon: Icons.set_meal,
  ...
  _Dish(
    ...
    imageAsset: 'assets/food/lentejas.jpg',
  ...
  _Dish(
    ...
    imageAsset: 'assets/food/arepas.jpg',
  ...
  _Dish(
    ...
    imageAsset: 'assets/food/fritos.jpeg',
    icon: Icons.fastfood,
    primary: AppColors.primary,
    secondary: AppColors.accentDeep,
    description: (r) =>
